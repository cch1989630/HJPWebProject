...
<head>
    ...
    <script type="text/javascript" src="web-res/js-default/printerManage.js"></script>
</head>
<style>
		...
		<div style="padding:10px 60px 20px 60px">
		    <form id="ff" method="post">
		    	<table cellpadding="5">
		    		<tr>
		    			<td>打印机名称</td>
		    			<td><input id="printerName" class="easyui-textbox" type="text" value="${printerName}" name="printerName" data-options="required:true"></input></td>
		    			<td><a href="#" onclick="testPrint()" class="easyui-linkbutton" data-options="iconCls:'icon-print'" style="width:120px">测试打印机</a></td>
		    		</tr>
		    	</table>
		    </form>
